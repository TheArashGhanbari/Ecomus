...
export default function CartMenu({ setIsOpen }) {
  useEffect(() => {
  ...
  return (
    <div
      className="h-[700px] inset-0 z-50 bg-black/40 fixed flex justify-end lg:hidden"
    ...
    >
      <motion.div
        ...
        className="w-full max-w-[477px] bg-white p-5 text-black flex flex-col flex-grow"
