...
function Header() {
  ...
  useEffect(() => {
    // Only reset to top on initial load
    if (!hasScrolled) {
      window.scrollTo(0, 0);
    }
  }, [hasScrolled]);
  ...
  return (
    <>
      <header
        className={`
          w-full bg-[#23242d] text-white border-b border-white/100 
          h-[60px] lg:h-[180px]
      ...
      mx-[-4px] top-[45px] mt-[1px]
      border border-white/100 rounded-2xl
      w-[367px] h-[290px] bg-[#23252e]
    ...
    "
            >
              <div className="pl-[21px] pr-[20px] pt-[24px] mt-[1px] rounded-2xl">
                <div className="flex flex-col gap-[20px] justify-start items-start cart-divider2">
                  {/* آیتم ۱ */}
                  <Link
                    href="/"
                    className="flex justify-center gap-[10px] items-center text-white transition-colors duration-300 ease-in-out hover:text-[rgb(153,21,242)] hover:translate-x-1"
                  >
                    <div className="w-[34px] h-[34px] rounded-full bg-amber-50 relative after:content-[''] after:absolute after:inset-[-4px] after:rounded-full after:border after:border-white after:z-[-1]">
                      <img
                        src="https://ecomus-2-2.myshopify.com/cdn/shop/collections/Banner22.jpg?v=1746584789&width=40"
                        alt="Setup Gear"
                        className="w-[34px] h-[34px] rounded-full"
                      />
                    </div>
                    <span className="relative custom-text">Setup Gear</span>
                  </Link>

                  {/* آیتم ۲ تا ۴ مشابه همین بالا هستن */}
                  {/* Adapters */}
                  <Link
                    href="/"
                    className="flex justify-center gap-[10px] items-center text-white transition-colors duration-300 ease-in-out hover:text-[rgb(153,21,242)] hover:translate-x-1"
                  >
                    <div className="w-[34px] h-[34px] rounded-full bg-amber-50 relative after:content-[''] after:absolute after:inset-[-4px] after:rounded-full after:border after:border-white after:z-[-1]">
                      <img
                        src="https://ecomus-2-2.myshopify.com/cdn/shop/collections/cate1.webp?v=1744950364&width=40"
                        alt="Adapters"
                        className="w-[34px] h-[34px] rounded-full"
                      />
                    </div>
                    <span className="relative custom-text">Adapters</span>
                  </Link>
                  ...
                  >
                    <div className="w-[34px] h-[34px] rounded-full bg-amber-50 relative after:content-[''] after:absolute after:inset-[-4px] after:rounded-full after:border after:border-white after:z-[-1]">
                      <img
                        src="https://ecomus-2-2.myshopify.com/cdn/shop/collections/ct3_e5743afb-a3cd-46c1-a4f9-4abe7e7d0cb4.webp?v=1744950299&width=40"
                        alt="Cables"
                        className="w-[34px] h-[34px] rounded-full"
                      />
                    </div>
                    <span className="relative custom-text">Cables</span>
                  </Link>
                  ...
                  >
                    <div className="w-[34px] h-[34px] rounded-full bg-amber-50 relative after:content-[''] after:absolute after:inset-[-4px] after:rounded-full after:border after:border-white after:z-[-1]">
                      <img
                        src="https://ecomus-2-2.myshopify.com/cdn/shop/collections/Banner-hp-3_a6301caa-febe-4b97-8dee-ce557d191531.jpg?v=1745400387&width=40"
                        alt="Headphone"
                        className="w-[34px] h-[34px] rounded-full"
                      />
                    </div>
                    <span className="relative">Headphone</span>
                  </Link>
                </div>
              </div>

              <div className="w-[365.4px] h-[53.4px] z-3 rounded-b-xl bg-[rgb(255,255,255,0.2)] hover:text-[rgb(153,21,242)]">
                <Link
                  href="/"
                  className="flex items-center justify-start px-[26px] py-[15px] gap-[5px] text-white transition-colors duration-300 ease-in-out hover:text-[rgb(153,21,242)] hover:translate-x-1"
                >
                  <div
                    className="
            flex items-center justify-start gap-[5px]
            border-b-2 border-[rgba(255,255,255,0.3)]
            hover:border-[rgb(153,21,242)]
          ...
          "
                  >
                    ...
                    <svg
                      ...
                      viewBox="0 0 8 8"
                      fill="none"
                      className="hover:text-[rgb(153,21,242)]"
                    >
                      <path
